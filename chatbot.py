...
We are going to use pyttsx3 for converting text to speech,
Wikipedia to get data from the web,
pyowm to get weather data,
and speech_recognition for converting speech to text using the google speech recognition engine.
...
#setup and caliberate text to speech engine
...
question = ['How are you?', 'How are you doing?','whats your name']
responses = ['Okay', "I'm fine","Savita bhabhi"]
...
if r.recognize_google(audio) in greetings:
       ...
       owm = pyowm.OWM('a8686d63bec3ca44513e4acfd46cc875')
